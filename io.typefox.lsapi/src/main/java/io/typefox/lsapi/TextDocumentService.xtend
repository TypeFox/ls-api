...
interface TextDocumentService {
     ...
     * 
     */
    def List<? extends CompletionItem> getCompletion(TextDocumentPositionParams position)
     ...
     */
    def Hover getHover(TextDocumentPositionParams position)
    
    /**
     * The signature help request is sent from the client to the server to request signature information at a given cursor
     * position.
     */
    def SignatureHelp getSignatureHelp(TextDocumentPositionParams position)
    
    /**
     * The goto definition request is sent from the client to the server to to resolve the defintion location of a symbol
     * at a given text document position.
     */
    def List<? extends Location> getDefinition(TextDocumentPositionParams position)
    
    /**
     * The references request is sent from the client to the server to resolve project-wide references for the symbol
     * denoted by the given text document position.
     */
    def List<? extends Location> getReferences(ReferenceParams params)
    
    /**
     * The document highlight request is sent from the client to the server to to resolve a document highlights for a
     * given text document position.
     */
    def DocumentHighlight getDocumentHighlight(TextDocumentPositionParams position)
    
    /**
     * The document symbol request is sent from the client to the server to list all symbols found in a given text document.
     */
    def List<? extends SymbolInformation> getDocumentSymbol(DocumentSymbolParams params)
     ...
     */
    def List<? extends Command> getCodeAction(CodeActionParams params)
    
    /**
     * The code lens request is sent from the client to the server to compute code lenses for a given text document.
     */
    def List<? extends CodeLens> getCodeLens(CodeLensParams params)
     ...
     */
    def List<? extends TextEdit> getFormatting(DocumentFormattingParams params)
    
    /**
     * The document range formatting request is sent from the client to the server to format a given range in a document.
     */
    def List<? extends TextEdit> getRangeFormatting(DocumentRangeFormattingParams params)
    
    /**
     * The document on type formatting request is sent from the client to the server to format parts of the document during typing.
     */
    def List<? extends TextEdit> getOnTypeFormatting(DocumentOnTypeFormattingParams params)
    
    /**
     * The rename request is sent from the client to the server to do a workspace wide rename of a symbol.
     */
    def WorkspaceEdit getRename(RenameParams params)
