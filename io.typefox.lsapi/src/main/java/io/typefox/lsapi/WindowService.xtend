...
interface WindowService {
	 ...
	 */
	def void onShowMessage(NotificationCallback<MessageParams> callback)
	 ...
	 */
	def void onShowMessageRequest(NotificationCallback<ShowMessageRequestParams> callback)
	
	/**
	 * The log message notification is send from the server to the client to ask the client to log a particular message.
	 */
	def void onLogMessage(NotificationCallback<MessageParams> callback)
