...
public interface TextDocumentService {
     ...
     */
    CompletableFuture<DocumentHighlight> documentHighlight(TextDocumentPositionParams position);
     ...
     */
    void onPublishDiagnostics(Consumer<PublishDiagnosticsParams> callback);
